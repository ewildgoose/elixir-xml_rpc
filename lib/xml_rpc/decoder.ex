...
defmodule XMLRPC.Decoder do
  ...
  * XMLRPC.Fault
  ...
  # Parse a method 'Call'
  defp parse(
         {:methodCall, [], method_name, {:"methodCall/params", [], params}},
         options
       )
  ...
  defp parse(
         {:methodCall, [], method_name, {:"methodCall/params", [], :undefined}},
         options
       ) do
  ...
  defp parse(
         {:methodCall, [], method_name, :undefined},
         options
       ) do
    %MethodCall{method_name: method_name, params: parse_params([], options)}
  end
  ...
  defp parse(
         {:methodResponse, [], {:"methodResponse/params", [], param}},
         options
       )
       when is_tuple(param) do
